...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dot2tex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11399&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dot2tex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dot2tex` can be installed with:

```
conda install dot2tex
```

It is possible to list all of the versions of `dot2tex` available on your platform with:
